...
import './XiwaDialog.scss';

export const XiwaDialog = ({
    className,
    variant,
    children,
    ...props
    ...
    <div
        {...props}
        className={classnames(className, 'xiwa-dialog', {
            'xiwa-dialog--success': variant === 'success',
            'xiwa-dialog--warning': variant === 'warning',
            'xiwa-dialog--error': variant === 'error',
        })}
    >
        {variant && (
            <svg
                className="xiwa-dialog__icon"
        ...
        <div className="xiwa-dialog__main">
            {children}
        </div>
    </div>
);

XiwaDialog.propTypes = {
